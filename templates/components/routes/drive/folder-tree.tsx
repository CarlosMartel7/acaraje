...
const Folder = imp("Folder@lucide-react")
const FolderOpen = imp("FolderOpen@lucide-react")
const MoreHorizontal = imp("MoreHorizontal@lucide-react")
const Pencil = imp("Pencil@lucide-react")
const FolderPlus = imp("FolderPlus@lucide-react")
const Trash2 = imp("Trash2@lucide-react")
const Check = imp("Check@lucide-react")
const ExternalLink = imp("ExternalLink@lucide-react")
const DropdownMenu = imp("DropdownMenu*@radix-ui/react-dropdown-menu")
const cn = imp("cn@@/lib/utils")
const Button = imp("Button@@/components/ui/button")
const Input = imp("Input@@/components/ui/input")

export const writeFolderTree = () => code`
...
export default writeFolderTree;
